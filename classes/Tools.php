...
// BEGIN - prestaclean edition
		fwrite($write_fd, "# PRESTACLEAN -- BEGIN \n");
		fwrite($write_fd, "# disallow the PestaShop IP ranges to make queries \n");
		fwrite($write_fd, "# Note: this will also make their support unavailable, \n");
		fwrite($write_fd, "# but hey, you can find help \n");
		fwrite($write_fd, "order allow,deny\n");
		fwrite($write_fd, "allow from all\n");
		fwrite($write_fd, "deny from 91.240.109.0-255\n");
		fwrite($write_fd, "# PRESTACLEAN -- END \n\n");
